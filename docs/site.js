...
const translations = {
  ...
  "Xuan++ 把分散在配置文件、数据库和启动参数里的操作收拢成可视化流程，同时保留每项增强的独立开关。": "Xuan++ turns operations scattered across config files, databases, and launch arguments into a visual workflow, while keeping every enhancement independently controllable.",
  ...
  "Xuan++ 管理工具真实界面": "The real Xuan++ manager interface",
  "控制中心，才是 Xuan++ 的主场": "The control center is where Xuan++ shines",
  ...
  "启动": "Launch",
  "以后从 Xuan++ 入口启动，已保存的配置会自动加载。": "Launch from the Xuan++ entry point from then on and your saved configuration will load automatically.",
  "下载 Xuan++": "Download Xuan++",
  ...
  "包含 Xuan++ 启动器和管理工具，并创建桌面与开始菜单入口。": "Includes the Xuan++ launcher and manager, with desktop and Start menu shortcuts.",
  ...
  "供应商密钥保存在本地配置边界中，不上传到 Xuan++ 项目或广告服务。": "Provider keys stay within local configuration and are never uploaded to the Xuan++ project or advertising services.",
  ...
  "Xuan++ 是 OpenAI 官方产品吗？": "Is Xuan++ an official OpenAI product?",
  "不是。Xuan++ 是社区维护的开源外部启动器与管理工具，面向 OpenAI Codex / ChatGPT 桌面应用使用。": "No. Xuan++ is a community-maintained, open-source external launcher and manager for the OpenAI Codex / ChatGPT desktop app.",
  "安装后为什么有两个入口？": "Why are there two app entries after installation?",
  "“Xuan++”用于日常静默启动并加载配置；“Xuan++ 管理工具”用于管理供应商、增强、脚本、更新和诊断。": "Xuan++ launches silently for everyday use and loads your configuration. Xuan++ Manager configures providers, enhancements, scripts, updates, and diagnostics.",
  "不使用第三方 API 可以吗？": "Can I use it without a third-party API?",
  "可以。选择官方登录模式即可只使用 ChatGPT / Codex 官方账号，Xuan++ 也能仅作为启动和增强管理工具。": "Yes. Select official sign-in to use only your ChatGPT / Codex account. Xuan++ can also serve solely as a launcher and enhancement manager.",
...
const pageMetadata = {
  zh: {
    title: "Xuan++ - Codex 桌面增强与管理工具",
    description: "Xuan++ 是面向 OpenAI Codex / ChatGPT 桌面应用的开源启动器与管理工具，提供供应商切换、会话管理、插件与脚本市场、界面增强等能力。",
    ogTitle: "Xuan++ - 让 Codex 按你的方式工作",
    ogDescription: "管理供应商、模型、会话、插件、脚本和界面增强。适用于 Windows 与 macOS。",
  },
  en: {
    title: "Xuan++ - Desktop enhancements and management for Codex",
    description: "Xuan++ is an open-source launcher and manager for the OpenAI Codex / ChatGPT desktop app, with provider switching, session management, plugins, scripts, themes, and interface enhancements.",
    ogTitle: "Xuan++ - Make Codex work your way",
    ogDescription: "Manage providers, models, sessions, plugins, scripts, themes, and interface enhancements on Windows and macOS.",
  },
  changelog: {
    zh: {
      title: "Xuan++ 更新日志",
      description: "Xuan++ 更新日志，查看每个版本的功能、改进与修复。",
      ogTitle: "Xuan++ 更新日志",
      ogDescription: "查看 Xuan++ 每个版本的功能、改进与修复。",
    },
    en: {
      title: "Xuan++ Changelog",
      description: "Xuan++ changelog with release features, improvements, and fixes.",
      ogTitle: "Xuan++ Changelog",
      ogDescription: "Explore the features, improvements, and fixes in every Xuan++ release.",
    },
  },
};
