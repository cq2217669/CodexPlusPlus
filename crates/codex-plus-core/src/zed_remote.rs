...
pub enum ZedRemoteError {
    ...
    #[error("Cannot read Xuan++ Zed remote project registry")]
    RegistryRead(#[source] std::io::Error),
    #[error("Cannot parse Xuan++ Zed remote project registry")]
    RegistryParse(#[source] serde_json::Error),
    #[error("Cannot write Xuan++ Zed remote project registry")]
